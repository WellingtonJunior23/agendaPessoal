...
// Escapa o e-mail recebido (se necessário, por precaução).
...
// Se não retornou nenhum registro, é porque o usuário não foi encontrado na tabela.
if( mysqli_num_rows($resultado)<=0 ) {
    $_SESSION['erroLogin'] = 'Usuário não encontrado no sistema.';
    irPara($_url_retorno);
}

// Obtém os dados do usuário na forma de um array associativo
